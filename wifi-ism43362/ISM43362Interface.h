...
public:
    ...
    */
    ...
    virtual int setCredentialsForAP(const char *ssid, const char *pass, nsapi_security_t security = NSAPI_SECURITY_NONE);
    virtual int startSoftAP();
    virtual int listenForConnection();
    virtual int saveWifiSettings();
    virtual int connectToWifiIfSaved();

    //virtual int openPairingSocket();
    //virtual int readDataFromClient();
