...
int ISM43362Interface::setCredentialsForAP(const char *ssid, const char *pass, nsapi_security_t security){
    return _ism.setCredentialsForAP(ssid, pass, security);
}

int ISM43362Interface::startSoftAP(){
    return _ism.startSoftAp();
}

int ISM43362Interface::listenForConnection(void){
    return _ism.listenForConnection();
}

int ISM43362Interface::saveWifiSettings(void){
    return _ism.saveWifiSettings();
}

int ISM43362Interface::connectToWifiIfSaved(void) {
    return _ism.connectToWifiIfSaved();
}

/*int ISM43362Interface::open_pairing_socket(void){
    return _ism.open_pairing_socket();
}

int ISM43362Interface::read_data_from_client(void){
    return _ism.read_data_from_client();
}*/
